...
class Bill_App:
    def __init__(self, root):
        ...
        lbl_color = 'white'
        # Title of App
        title = Label(self.root, text="Billing Software", bd=15, relief=GROOVE, fg="#000000", bg="grey",
        ...
        # ===============Customer Name===========#
        cname_lbl = Label(F1, text="Customer Name", bg="red", fg=fg_color,
        ...
        # =================Customer Phone==============#
        cphon_lbl = Label(F1, text="Phone No", bg="red", fg=fg_color, font=("times new roman", 15, "bold")).grid(
            row=0, column=2, padx=20)
        cphon_en = Entry(F1, bd=8, relief=GROOVE, textvariable=self.c_phone)
        cphon_en.grid(row=0, column=3, ipady=4, ipadx=30, pady=5)

        # ====================Customer Bill No==================#
        cbill_lbl = Label(F1, text="Bill No.", bg="red", fg=fg_color, font=("times new roman", 15, "bold"))
        ...
        # ====================Bill Search Button===============#
        bill_btn = Button(F1, text="Enter", bd=7, relief=GROOVE, font=("times new roman", 12, "bold"), bg="pink",
                          fg=bg_color)
        bill_btn.grid(row=0, column=6, ipady=5, padx=60, ipadx=19, pady=5)

        # ==================Cosmetics Frame=====================#
        F2 = LabelFrame(self.root, text='Cosmetics', bd=10, relief=GROOVE, bg=bg_color, fg="orange",
                        font=("times new roman", 13, "bold"))
        F2.place(x=5, y=180, width=325, height=380)

        # ===========Frame Content
        bath_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=fg_color, bg=bg_color, text="Bath Soap")
        ...
        # ==================Grocery Frame=====================#
        F2 = LabelFrame(self.root, text='Grocery', bd=10, relief=GROOVE, bg=bg_color, fg="orange",
                        font=("times new roman", 13, "bold"))
        ...
        F2 = LabelFrame(self.root, text='Others', bd=10, relief=GROOVE, bg=bg_color, fg="orange",
                        font=("times new roman", 13, "bold"))
        ...
        # ===========Buttons Frame=============#
        F4 = LabelFrame(self.root, text='Bill Menu', bd=10, relief=GROOVE, bg="#186e1d", fg="#f5ff00",
                        font=("times new roman", 13, "bold"))
        F4.place(x=0, y=560, relwidth=1, height=145)

        # ===================
        cosm_lbl = Label(F4, font=("times new roman", 15, "bold"), fg=lbl_color, bg="#186e1d", text="Total Cosmetics")
        ...
        # ===================
        gro_lbl = Label(F4, font=("times new roman", 15, "bold"), fg=lbl_color, bg="#186e1d", text="Total Grocery")
        ...
        # ================
        oth_lbl = Label(F4, font=("times new roman", 15, "bold"), fg=lbl_color, bg="#186e1d", text="Others Total")
        ...
        # ================
        cosmt_lbl = Label(F4, font=("times new roman", 15, "bold"), fg=lbl_color, bg="#186e1d", text="Cosmetics Tax")
        ...
        # =================
        grot_lbl = Label(F4, font=("times new roman", 15, "bold"), fg=lbl_color, bg="#186e1d", text="Grocery Tax")
        ...
        # ==================
        otht_lbl = Label(F4, font=("times new roman", 15, "bold"), fg=lbl_color, bg="#186e1d", text="Others Tax")
        ...
        # ====================
        total_btn = Button(F4, text="Total", bg="white", fg="red", font=("lucida", 12, "bold"), bd=7, relief=GROOVE,
                           command=self.total)
        total_btn.grid(row=1, column=4, ipadx=20, padx=30)

        # ========================
        genbill_btn = Button(F4, text="Generate Bill", bg="white", fg="red", font=("lucida", 12, "bold"), bd=7,
                             relief=GROOVE, command=self.bill_area)
        genbill_btn.grid(row=1, column=5, ipadx=20)

        # ====================
        clear_btn = Button(F4, text="Clear", bg="red", fg="black", font=("lucida", 12, "bold"), bd=7, relief=GROOVE,
                           command=self.clear)
    ...
    def welcome_soft(self):
        ...
        self.txt.insert(END, "       Welcome To More's Retail\n")
